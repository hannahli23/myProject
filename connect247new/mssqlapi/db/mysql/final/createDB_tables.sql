...
DROP TABLE IF EXISTS `fpp`.`questions`;
  ...
  `questionSetTitle` NVARCHAR(300) NULL DEFAULT 'Default 2017 AMC8 ',
  `questionSetURL` NVARCHAR(300) NULL DEFAULT 'https://artofproblemsolving.com/wiki/index.php?title=AMC_8_Problems_and_Solutions',
